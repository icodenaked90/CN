...
function vRPmt.indbrudAlarm()
  TriggerEvent("pNotify:SendNotification", {
  text = "Du har udløst alarmen, politiet er på vej",
  type = "info",
  timeout = 2500,
  layout = "bottomCenter",
  theme = "gta"
...
function vRPmt.CarModelCheck()
  local lPed = GetPlayerPed(-1)
  local vehicle = GetVehiclePedIsIn(lPed)
  return IsVehicleModel(vehicle, "trash")
end
function vRPmt.AirplaneModelCheck()
  local lPed = GetPlayerPed(-1)
  local vehicle = GetVehiclePedIsIn(lPed)
  return IsVehicleModel(vehicle, "cuban800")
end