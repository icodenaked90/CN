...
AddEventHandler("notrucker", function()
	TriggerEvent("pNotify:SendNotification",{text = "Du er ikke lastbilchauffør",type = "error",timeout = (5000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
end)

RegisterNetEvent("yestrucker")
AddEventHandler("yestrucker", function()
	SpawnVan()
	TriggerEvent("pNotify:SendNotification",{text = "God arbejdslyst!",type = "success",timeout = (5000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
end)

RegisterNetEvent("notruck")
AddEventHandler("notruck", function()
	SpawnVan()
	TriggerEvent("pNotify:SendNotification",{text = "Du skal være i din lastbil for at starte ruten!",type = "error",timeout = (5000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
end)
...
function SpawnVan()
	if (IsInVehicle()) then
		if IsVehicleModel(GetVehiclePedIsIn(GetPlayerPed(-1), true), GetHashKey("packer")) or IsVehicleModel(GetVehiclePedIsIn(GetPlayerPed(-1), true), GetHashKey("phantom")) or IsVehicleModel(GetVehiclePedIsIn(GetPlayerPed(-1), true), GetHashKey("phantom3")) then
			...
			SetVehicleNumberPlateText(spawned_car, "HYPN"..plate)
