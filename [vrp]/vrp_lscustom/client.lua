...
local garages = {
	...
	[7] = { locked = false, camera = {x = 877.441, y = -3246.062, z = -98.285, heading = 88.726}, driveout = {x = 873.132,y = -3245.980, z = -98.288, heading = 88.944}, drivein = {x = 869.336,y = -3245.908, z = -98.291, heading = 88.961}, outside = {x = 865.545,y = -3245.993, z = -98.294, heading = 90.494}, inside = {x = 860.964,y = -3246.108, z = -98.294, heading = 90.762} }
}
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		local maxvehhp = 1000
		local damage = 0
		damage = (maxvehhp - GetVehicleBodyHealth(veh))/10
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		local veh = GetVehiclePedIsUsing(ped)
		pos = currentpos
		TaskVehicleDriveToCoord(ped, veh, pos.outside.x, pos.outside.y, pos.outside.z, f(5), f(0.1),
		(veh), 16777216, f(0.1), true)
...
myveh.model =  GetDisplayNameFromVehicleModel(VehicleModel)

local VehicleName = GetLabelText(VehicleNameLabel)

--print(playerVeh .. ' - '  .. VehicleModel .. ' - '  .. VehicleNameLabel .. ' - '  .. VehicleName) --debug
