...
houses = {
	{
		...
		door = vec3(265.985, -1007.247, -101.008-0.95),
		...
		pickups = {
			{
				...
				rotation = 20.0,
				value = 1000 -- the money which the item is worth
			},
			{
	...
	},
	{
		...
		door = vec3(346.420, -1012.641, -99.196-0.95),
		pickups = {
			{
	...
	},
	{
		...
		door = vec(151.29, -1007.59, -99.0-0.95),
		area = {
	...
	},
	{
		...
		door = vec3(172.9, -1008.34, -99.0-0.95),
		area = {
