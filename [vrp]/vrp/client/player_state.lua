...
Citizen.CreateThread(function()
  while true do
    ...
    if IsPlayerPlaying(PlayerId()) and state_ready then
      ...
      if oldWheel ~= nil then
        local changed = false
        for k,v in pairs(weapons) do
          if oldWheel[k] == nil or oldWheel[k].ammo ~= weapons[k].ammo then
            changed = true
          end
        end
        for k,v in pairs(oldWheel) do
          if weapons[k] == nil or weapons[k].ammo ~= oldWheel[k].ammo then
            changed = true
          end
        end
