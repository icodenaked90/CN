...
function tvRP.toggleFreeze()
    if frozen then
        frozen = false
        unfreeze = true
        --TriggerEvent("pNotify:SendNotification",{text = "Du blev optøet af en admin.",type = "info",timeout = (3000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})
    else
        frozen = true
        unfreeze = false
        --TriggerEvent("pNotify:SendNotification",{text = "Du blev frosset af en admin.",type = "info",timeout = (3000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})
    end
end
...
local function teleportToWaypoint()
    ...
    if(not IsWaypointActive())then
        TriggerEvent("pNotify:SendNotification",{text = "Du mangler at sætte et waypoint",type = "warning",timeout = (3000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
        return
    end
  ...
  --  TriggerEvent("pNotify:SendNotification",{text = "Teleporteret til waypoint",type = "success",timeout = (3000),layout = "centerLeft",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
end
