...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn)
  ...
  if first_spawn then -- first spawn
    ...
    -- notify last login
    SetTimeout(3000,function()TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.common.welcome({tmpdata.last_login})}, type = "info", queue = "global", timeout = 10000, layout = "bottomCenter",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})end)
