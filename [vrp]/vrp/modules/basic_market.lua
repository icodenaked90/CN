                        ...
                        if amount > 0 then
                            ...
                            if new_weight <= vRP.getInventoryMaxWeight(user_id) then
                                ...
                                if vRP.tryFullPayment(user_id,amount*price) then
                                    ...
                                    TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.money.paid({amount*price})}, type = "success", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
                                else
                                ...
                                TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.inventory.full()}, type = "error", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
                            end
                        else
