...
local lang = {
  common = {
    welcome = "<center>Velkommen til <b style='color: #72AEE5'>CiviliansNetwork</b>.<br>Tryk på <b style='color: #4E9350'>F9</b> for at åbne menuen.</center>",
  ...
  cityhall = {
    ...
    menu = {
      title = "Identitet",
      info = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Fødselsdato</b>: {3}<br /><b>CPR</b>: {4}<br />Kørekort</b>: {7}<br /><b>Adresse</b>: {5} {6}<br /><b>Job</b>: {10}<br /><b>ID</b>: {9}",
      firmainfo = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Fødselsdato</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Kørekort</b>: {7}<br /><b>Adresse</b>: {5} {6}<br /><b>Job</b>: {10}<br /><b>Firma</b>: {11}<br /><b>Kapital</b>: {12} DKK<br /><b>ID</b>: {9}"
    }
  },
  police = {
    title = "Politi",
    ...
    menu = {
      ...
      licenseGive = {
        title = "Tildel kørekort",
        description = "Tildel kørekort til en person."
      },
      searchcar = {
      ...
      kiss = {
        title = "Bed om et kys",
        description = "Spørg om et kys fra den nærmeste spiller.",
        request = "Vil du giv et kys?",
        asked = "Spørger om kys..."
      },
      check = {
    ...
    identity = {
      info = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Alder</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Mobilnummer</b>: {5}<br /><br /><b>Adresse</b>: {6}<br /><b>Job</b>: {7}<br /><br /><b>Firma</b>: {8}",
      driverlicense = "<b>Fornavn</b>: {1}<br /><b>Efternavn</b>: {2}<br /><b>Fødselsdato</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Kørekort</b>: {5}",
      infocpr = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Fødselsdato</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Mobilnummer</b>: {5}<br /><b>Kørekort</b>: {6}<br /><br /><b>Adresse</b>: {7} {8}<br /><b>Firma</b>: {9}<br /><b>Kapital</b>: {10}<br /><b>Job</b>: {11}"
    }
  },
  emergency = {
	title = "Læge",
