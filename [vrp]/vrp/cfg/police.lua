...
cfg.seizable_items = {
	...
	"ARMOR",
	--Weapons, attachments
	"extended|WEAPON_VINTAGEPISTOL",
	"extended|WEAPON_SNSPISTOL",
	"extended|WEAPON_PISTOL",
	"silencer|WEAPON_VINTAGEPISTOL",
	"silencer|WEAPON_PISTOL_MK2",
	"silencer|WEAPON_PISTOL",
