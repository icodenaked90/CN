...
spawnNotif = {
contact = "Annonym kontakt",
title = "~r~Et beskidt job",
msg = "~g~En pansret varevogn er lige blevet spottet, forbered dit team"
},

copsSpawnNotif = {
contact = "Direktør af Gruppe 6 Pengetransport",
title = "~r~Transport af penge",
msg = "~g~Vi har sendt en pengetransport afsted."
},

rewardnotif = {"Du har modtaget ~g~"," ~w~$ Dollars."},
onMapBlipName_truck = "Penge Transport",
copsOnMapBlipName_truck = "Penge Transport",
onMapBlipName_money = "Penge Pose",
destroyedTruckNotif = "~r~ Penge Transporten er blevet ødelagt",
cops_notification = "Et røveri er i gang ~y~",
cops_Collect_money = "~y~Politibetjent inddriver penge efter røveri af en pansret varevogn.",
cops_Veh_plate = {"~r~Spor Fundet","~y~Mistænkt køretøj:  ~g~","  ~y~Model :  ~g~"},
copsNoClueNofif = "~y~ ingen spor i øjeblikket...",
...
-----------------[SPAWN TIMER]---------------------
cfg.spawnTimer = math.random(60000*1,60000*1)
---------------------------------------------------
--
-----------------[DESPAWN TIMER]-------------------
cfg.despawnTimer = math.random(60000*1,60000*1)
---------------------------------------------------
