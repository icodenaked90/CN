...
AfterHoursNightclubs = {
    ...
    LoadDefault = function()
        ...
        AfterHoursNightclubs.Interior.Podium.Set(AfterHoursNightclubs.Interior.Podium.trad)
        ...
        -- Lights
        AfterHoursNightclubs.Interior.Lights.Bands.Set(AfterHoursNightclubs.Interior.Lights.Lasers.white)
        AfterHoursNightclubs.Interior.Lights.Lasers.Clear()
