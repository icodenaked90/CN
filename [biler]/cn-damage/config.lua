...
cfg = {
	deformationMultiplier = 0.5,					-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch. Visual damage does not sync well to other players.
	...
	weaponsDamageMultiplier = 1.20,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
	...
	degradingFailureThreshold = 52.0,			-- Below this value, slow health degradation will set in
	cascadingFailureThreshold = 51.0,			-- Below this value, health cascading failure will set in
...
--[[cfg = {
	...
	deformationMultiplier = 3,					-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch
