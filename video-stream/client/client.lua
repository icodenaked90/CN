...
local streamURL = string.format("http://ts.fivem.dk:8080/dui/index.html", endpoint)
local streamOfflineURL = string.format("http://ts.fivem.dk:8080/dui/index.html", endpoint)
