...
-- You can disable the Favorite emote keybinding here.
	...
	FavKeybind = 244, -- Get the button number here https://docs.fivem.net/game-references/controls/
-- You can change the header image for the f3 menu here
-- Use a 512 x 128 image!
-- NOte this might cause an issue of the image getting stuck on peoples screens
	CustomMenuEnabled = true,
	MenuImage = "https://i.imgur.com/W0flRys.png",
...
Config.Languages = {
  ['en'] = {
        ...
        ['favoriteinfo'] = "Vælg dine favorit emotes her",
        ['rfavorite'] = "Nulstil favoritter",
        ['prop2info'] = "❓ Prop Emotes can be located at the end",
        ['set'] = "Sæt (",
        ['setboundemote'] = ") til at være din keybinded emote?",
        ['newsetemote'] = "~w~ er nu keybinded, tryk ~g~M~w~ for at bruge den.",
        ['cancelemote'] = "Stop Emote",
        ['cancelemoteinfo'] = "~r~X~w~ Stopper den nuværende emote",
        ['walkingstyles'] = "Gå måder",
        ['resetdef'] = "Sæt til standart",
        ['normalreset'] = "Normal (Standart)",
        ['moods'] = "Humør",
        ...
        ['nocancel'] = "Du er ikke igang med en mote.",
        ['maleonly'] = "Den her emote virker desværre kun til mænd :(",
        ['emotemenucmd'] = "Skriv /emotemenu for menuen.",
        ['shareemotes'] = "👫 Delte emotes",
        ['shareemotesinfo'] = "Spørg nærmeste person om at lave en emote",
        ['sharedanceemotes'] = "🕺 Delte danse",
        ['notvalidsharedemote'] = "er ikke en gyldig delt emote.",
        ['sentrequestto'] = "Invitiation sendt til ~y~",
        ['nobodyclose'] = "Der er ~r~ingen~w~ i nærheden..",
        ['doyouwanna'] = "~y~Y~w~ for at acceptere, ~r~L~w~ for at afvise (~g~",
        ['refuseemote'] = "Emote afvist.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Tryk ~y~,~w~ for at bruge blitzen",
        ['makeitrain'] = "Tryk ~y~,~w~ for at lave penge regn",
        ['pee'] = "Tryk ~y~,~w~ for at pisse",
        ['spraychamp'] = "Tryk ~y~,~w~ for at sprøje champagne",
        ['bound'] = "Bind ",
        ['to'] = "til",
        ['currentlyboundemotes'] = " Nuværende bundne emotes:",
        ['notvalidkey'] = "er ikke en tilladt keybind.",
        ['keybinds'] = "🔢 Keybinds",
        ['keybindsinfo'] = "Brug"
  },
  ['fr'] = {
