...
DrawAdvancedText(0.603, 0.903, 0.005, 0.0028, 0.4, "Detaljer om køretøjet", 0, 191, 255, 255, 6, 0)
DrawAdvancedText(0.6, 0.956, 0.009, 0.0028, 0.4, details, 255, 255, 255, 255, 6, 0)
end
end
end)
