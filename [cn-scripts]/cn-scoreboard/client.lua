        ...
        if spawned then
            ...
            if IsControlPressed(0, 344) then
                ...
                if users.ems ~= nil then
                    ...
                    DrawText3D("Journalist: "..users.journalist,0.5,0.43,0.8,255,255,255,255)
                    ...
                    DrawText3D("Forsyningen: "..users.forsyningen,0.5,0.55,0.8,255,255,255,255)
                    local onlinetpos = 0.60
                    local height = 0.54
                    local y = 0.390

                        DrawText3D("Politi: 🤔",0.5,onlinetpos-0.01,0.8,255,255,255,255)
