...
AddEventHandler('service:startCall', function (number, message, coords)
    ...
    if number == "Politi-Job" or number == "EMS-Job" or number == "Forsyningen-Job" then
        vRP.getUserIdentity({user_id, function(identity)
            local discord = "https://discordapp.com/api/webhooks/628518994260918283/_F0ujbWCYFFb9hXkGd5DWdY74gVnSdWNAEAnefikL2vH2k9qlsdC8lEAC1VR6gNlfK74"
            if number == "EMS-Job" then
                discord = "https://discordapp.com/api/webhooks/668572512036192286/d7d-qBmeP-974vDqfcLFm5VaddoUcmtb4sK7B9qMMGq1xAXVY6TZeVzIq6zJe7MJW49w"
            end
            if number == "Forsyningen-Job" then
                discord = "https://discordapp.com/api/webhooks/666798713561284648/N4nptpdzC5eFSZlY080j_7hr7WyBnarYtVOUqzllah-5P2ktIdcMfJJqiPSjLzLeBEpo"
            end
