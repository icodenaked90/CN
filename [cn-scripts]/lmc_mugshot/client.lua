...
Citizen.CreateThread(function()
    ...
    while true do
        Citizen.Wait(0)
        if IsControlJustPressed(1, 212) and not IsPedInAnyVehicle(PlayerPedId(), true) and not IsPedSwimming(PlayerPedId(), true) and GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),473.62033081055,-978.75805664063,24.914749145508, true) <= 5 then
