...
------
RegisterServerEvent('InteractSound_SV:PlayWithinDistanceWithSource')
AddEventHandler('InteractSound_SV:PlayWithinDistanceWithSource', function(source,maxDistance, soundFile, soundVolume)
