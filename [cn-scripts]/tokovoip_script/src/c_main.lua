...
RegisterNetEvent("joinRadio")
AddEventHandler('joinRadio', function(bande,ped)
  bande = bande
  ped = GetPlayerPed(-1)
		addPlayerToRadio(bande)
end)

RegisterNetEvent("leaveRadio")
AddEventHandler('leaveRadio', function(bande,ped)
  bande = bande
  ped = GetPlayerPed(-1)
		removePlayerFromRadio(bande)
end)
