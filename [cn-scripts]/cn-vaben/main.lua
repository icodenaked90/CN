	...
	while true do
		...
		for i=1, #Config.RealWeapons, 1 do
    		...
    		if HasPedGotWeapon(playerPed, weaponHash, false) then
    			...
    			GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_CARBINERIFLE"), GetHashKey("COMPONENT_CARBINERIFLE_CLIP_01"))
        		...
        		GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_SMG"), GetHashKey("COMPONENT_SMG_VARMOD_NAVY"))
        		-- Finskytte sigte
				...
				--Vintage gun (drugdealer)
        		--GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_VINTAGEPISTOL"), GetHashKey("COMPONENT_VINTAGEPISTOL_CLIP_02"))
        		--GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_VINTAGEPISTOL"), GetHashKey("COMPONENT_AT_PI_SUPP"))
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(30000) collectgarbage()
	end
