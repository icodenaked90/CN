        ...
        if ( IsPedSittingInAnyVehicle( ped ) ) then
            ...
            if ( GetPedInVehicleSeat( vehicle, -1 ) == ped and GetVehicleClass( vehicle ) == 18 ) then
                            ...
                            if lastplate ~= fwdPlate then
                                ...
                                for k,v in pairs(users) do
                                    if "P "..v.reg == fwdPlate then
                                        if v.warned ~= false or v.license == 0 or v.license == 2 then
                ...
                if ( radarInfo.bwdXmit ) then
                    ...
                    local _, bwdZ = GetGroundZFor_3dCoord( bwdPos.x, bwdPos.y, bwdPos.z + 800.0 )
...
--             if radarInfo.selectedUser.license == 0 and radarInfo.selectedUser.warned == false then
--                 local driver = "Nej"
